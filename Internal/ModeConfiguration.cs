...
internal static class ModeConfiguration
{
    public static byte[] CC1100_GFSK__1_2kb =
    {
    ...
    public static byte[] CC1100_GFSK__38_4kb =
    {
        0x07, // IOCFG2        GDO2 Output Pin Configuration
        0x2E, // IOCFG1        GDO1 Output Pin Configuration
        0x80, // IOCFG0        GDO0 Output Pin Configuration
    ...
    public static byte[] CC1100_GFSK__100kb =
    {
        0x07, // IOCFG2        GDO2 Output Pin Configuration
        0x2E, // IOCFG1        GDO1 Output Pin Configuration
        0x80, // IOCFG0        GDO0 Output Pin Configuration
    ...
    public static byte[] CC1100_MSK__250kb =
    {
    ...
    public static byte[] CC1100_MSK__500kb =
    {
        0x07, // IOCFG2        GDO2 Output Pin Configuration
        0x2E, // IOCFG1        GDO1 Output Pin Configuration
        0x80, // IOCFG0        GDO0 Output Pin Configuration
    ...
    public static byte[] CC1100_OOK__4_8kb =
    {
